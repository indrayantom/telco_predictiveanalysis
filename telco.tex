...
\newcommand{\exam}{HOMEWORK DAY 27}

\title{Telco Customer Churn Predictive Learning} %Enter the title of your report 
\date{January 2022} % insert a specific date	
